  ...
  return (
    <div className="rounded-lg border bg-card p-4 shadow-sm">
      <div className="relative mb-2 flex flex-row items-start justify-between">
        <div className="flex flex-row items-center justify-start gap-2">
          <img
            ...
            alt={formattedAuthor}
            className="h-10 w-10 rounded-full bg-muted object-cover ring-1 ring-border"
          />
      ...
      <div className="flex flex-col gap-2">
        <h3 className="wrap-break-word text-lg leading-snug font-semibold text-card-foreground">
          {question.body}
        </h3>
